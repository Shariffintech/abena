...
ActiveRecord::Schema.define(version: 2022_03_23_171219) do
  ...
  create_table "students", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "strategies_id"
    t.index ["strategies_id"], name: "index_students_on_strategies_id"
  ...
  add_foreign_key "students", "strategies", column: "strategies_id"
